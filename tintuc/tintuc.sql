...
-- Dumping structure for table tin_tuc.admins
...
-- Dumping data for table tin_tuc.admins: ~3 rows (approximately)
DELETE FROM `admins`;
...
-- Dumping structure for table tin_tuc.banners
...
-- Dumping data for table tin_tuc.banners: ~3 rows (approximately)
DELETE FROM `banners`;
...
INSERT INTO `banners` (`id`, `name_url`, `user_id`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	...
	(70, '20200330044022pm2.2.2 Suy tim (4).jpg', 1, 1, 1, NULL, NULL),
	(71, '20200330044026pm2.2.2 Suy tim (4).jpg', 1, 1, 1, NULL, NULL);
/*!40000 ALTER TABLE `banners` ENABLE KEYS */;

-- Dumping structure for table tin_tuc.categpries
...
-- Dumping data for table tin_tuc.categpries: ~5 rows (approximately)
...
-- Dumping structure for table tin_tuc.comments
...
-- Dumping data for table tin_tuc.comments: ~0 rows (approximately)
DELETE FROM `comments`;
/*!40000 ALTER TABLE `comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `comments` ENABLE KEYS */;

-- Dumping structure for table tin_tuc.comment_posts
...
-- Dumping data for table tin_tuc.migrations: ~11 rows (approximately)
...
-- Dumping structure for table tin_tuc.password_resets
...
-- Dumping data for table tin_tuc.password_resets: ~0 rows (approximately)
DELETE FROM `password_resets`;
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Dumping structure for table tin_tuc.permissions
...
-- Dumping data for table tin_tuc.permissions: ~8 rows (approximately)
...
-- Dumping structure for table tin_tuc.permission_role
...
-- Dumping data for table tin_tuc.permission_role: ~26 rows (approximately)
...
-- Dumping structure for table tin_tuc.posts
...
-- Dumping data for table tin_tuc.posts: ~2 rows (approximately)
DELETE FROM `posts`;
...
-- Dumping structure for table tin_tuc.roles
...
-- Dumping data for table tin_tuc.roles: ~3 rows (approximately)
DELETE FROM `roles`;
...
-- Dumping structure for table tin_tuc.role_user
...
-- Dumping data for table tin_tuc.role_user: ~4 rows (approximately)
...
INSERT INTO `role_user` (`id`, `user_id`, `role_id`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	...
	(37, 8, 2, 8, 8, '2020-03-29 16:07:15', '2020-03-29 16:07:15');
/*!40000 ALTER TABLE `role_user` ENABLE KEYS */;

-- Dumping structure for table tin_tuc.users
...
-- Dumping data for table tin_tuc.users: ~3 rows (approximately)
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `name`, `avatar`, `username`, `email`, `email_verified_at`, `password`, `remember_token`, `updated_by`, `created_by`, `created_at`, `updated_at`) VALUES
	(1, 'nguyen', NULL, NULL, 'nguyen@gmail.com', NULL, '$2y$10$RDx2HUa/Fx7yoxHp6oStcu02Ts4.Wd/MxKtIau9jVBnnnE590TJBq', 'KAD5aP3FlCwQ9CVxYfxJ0UUOfVAgkAhsvVPaXQKLcE9zaShgG803H5y7OEFr', 0, 0, '2020-03-11 15:34:08', '2020-03-30 02:21:16'),
	(8, 'tran ngoc hieu', NULL, NULL, 'vu97kt@gmail.com', NULL, '$2y$10$gNFP5rthtkqLlVsjYHFAa.aUseuS2rEI2a8M77E2Jw9IGxNAJMLeS', 'nT9SoYn0qpkbbrREoEH5UBu8IzlORW5DnQHZn6u7NcTQSDhpqyJVTpfCCtSS', 0, 0, '2020-03-11 17:10:57', '2020-03-30 09:47:56'),
